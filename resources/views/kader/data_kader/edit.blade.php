                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <select id="Jenis Kelamin" class="select2 form-select" name="jenis_kelamin" value="{{$data->jenis_kelamin}}">
                            ...
                            <option value="Perempuan"                             <option value="Perempuan" {{ $data->jenis_kelamin == "Perempuan" ? 'selected' : ''}}>Perempuan</option>
                        </select>
                    </div>
                    <div class="mb-3 col-md-6">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="password" id="Password" name="password" value="{{$data->password}}" autofocus />
                    </div>
                    <div class="mb-3 col-md-6">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <div class="input-group input-group-merge">
                            <input type="text" id="Role" name="role" value="{{$data->role}}"" class="form-control"/>
                        </div>
                    </div>
                </div>
                <div class="mt-2">
